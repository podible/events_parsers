...
apps = [
    {"name": "Abandon", "pattern": re.compile("Abandon/"), "examples": ["Abandon/1.15.28.58.6 CFNetwork/711.3.18 Darwin/14.0.0"]},
    {
        "name": "Acast",
        "pattern": re.compile("^Acast.+([Aa]ndroid|iOS|Darwin)"),
        "examples": ["Acast/3989 CFNetwork/758.4.3 Darwin/15.5.0"],
    },
    {"name": "Accompany", "pattern": re.compile("Accompany/"), "examples": ["Accompany/462 CFNetwork/758.5.3 Darwin/15.6.0"]},
    {"name": "ActiasLuna", "pattern": re.compile("ActiasLuna/"), "examples": ["ActiasLuna/1.1.3 CFNetwork/672.1.14 Darwin/14.0.0"]},
    {
    ...
    {"name": "Agora", "pattern": re.compile("^Agora/"), "examples": ["Agora/37 CFNetwork/974.2.1 Darwin/18.0.0"]},
    {"name": "AhaRadio", "pattern": re.compile("^AhaRadio2/"), "examples": ["AhaRadio2/8.12.3 CFNetwork/976 Darwin/18.2.0"]},
    {
        "name": "Airr",
        ...
        "examples": [
            ...
            "Airr%20Beta/672 CFNetwork/978.0.7 Darwin/18.5.0",
            "Airr (airr.io)",
        ],
    },
    {
    ...
    {"name": "AlienBlue", "pattern": re.compile("^AlienBlue/"), "examples": ["AlienBlue/2.9.7 CFNetwork/808.2.16 Darwin/16.3.0"]},
    {
    ...
    {"name": "Aloha", "pattern": re.compile("^Aloha/"), "examples": ["Aloha/2 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {
        "name": "Amazon Fire",
        ...
        "examples": [
            ...
            "Amazon;AFTEAMR311;756a522d9f1648b89e76e80be654456a;;tpapi",
            "Amazon;AFTEU014;756a522d9f1648b89e76e80be654456a;;tpapi",
        ],
    },
    {
        "name": "Amazon Music",
        ...
        "examples": [
            ...
            "Harley/3.12.0.78 A1CTGXB4BA274T/9.4.0.2386",
            "Harley/3.11.0.181 A5FPM1T85BR19/9.2.1.2362a",
        ],
        "comments": "Harley found coming from the Amazon Music desktop app.",
    },
    {"name": "AMPApp", "pattern": re.compile("^AMPApp/"), "examples": ["AMPApp/32.6.1 CFNetwork/978.0.7 Darwin/18.6.0"]},
    {"name": "Anchor", "pattern": re.compile("^Anchor/"), "examples": ["Anchor/9 CFNetwork/901.1 Darwin/17.5.0"]},
    {"name": "AnchorFM", "pattern": re.compile("^AnchorFM/"), "examples": ["AnchorFM/3.0 (Linux;Android 6.0) ExoPlayerLib/2.5.4"]},
    {
    ...
    },
    {
        ...
        "examples": [
            ...
            "%D8%A3%D9%86%D8%BA%D8%A7%D9%85%D9%8A/601041 CFNetwork/1335.0.3 Darwin/21.6.0",
        ],
    },
    {
        "name": "AntennaPod",
    ...
    },
    {
        ...
        "urls": ["https://github.com/amugofjava/anytime_podcast_player"],
    ...
    {"name": "Apollo", "pattern": re.compile("^Apollo/"), "examples": ["Apollo/11.28 CFNetwork/1085.4 Darwin/19.0.0"]},
    {
        "name": "Apple iMessage",
        ...
        "examples": [
            ...
            "Messages Share Extension/5500 CFNetwork/1098 Darwin/19.0.0 (x86_64)",
            "MessagesNotificationExtension/1 CFNetwork/1098.7 Darwin/19.0.0",
        ],
    },
    {
        "name": "Apple Mail",
    ...
    },
    {
        ...
        "examples": [
            ...
            "البودكاست/1530.3 CFNetwork/1209 Darwin/20.2.0",
            "พ็อดคาสท์/1440.4 CFNetwork/1126 Darwin/19.5.0",
            "ポッドキャスト/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "פודקאסטים/1420.35 CFNetwork/1120 Darwin/19.0.0",
            "Подкасти/1520.39 CFNetwork/1206 Darwin/20.1.0",
            "%D8%A7%D9%84%D8%A8%D9%88%D8%AF%D9%83%D8%A7%D8%B3%D8%AA/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "Подкасты/1520.39 CFNetwork/1206 Darwin/20.1.0",
            "%D0%9F%D0%BE%D0%B4%D0%BA%D0%B0%D1%81%D1%82%D1%8B/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "%D0%9F%D0%BE%D0%B4%D0%BA%D0%B0%D1%81%D1%82%D0%B8/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "Podcastok/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "%D7%A4%D7%95%D7%93%D7%A7%D7%90%D7%A1%D7%98%D7%99%D7%9D/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "%ED%8C%9F%EC%BA%90%EC%8A%A4%ED%8A%B8/1410.25.1 CFNetwork/1107.1 Darwin/19.0.0",
            "%D8%A7%D9%95%D8%B3%D9%85%D8%B9%D9%84%D9%8A/1.0 CFNetwork/609.1.4 Darwin/13.0.0",
            "पॉडकास्ट/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "播客/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "팟캐스트/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "Podcasty/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "Podcaster/1660.5 CFNetwork/1335.0.3 Darwin/21.6.0",
            "Podcaster/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "%E6%92%AD%E5%AE%A2/1660.5 CFNetwork/1335.0.3 Darwin/21.6.0",
            "%E3%83%9D%E3%83%83%E3%83%89%E3%82%AD%E3%83%A3%E3%82%B9%E3%83%88/1709.2.2 CFNetwork/1390 Darwin/22.0.0",
            "Podcastit/1660.5 CFNetwork/1335.0.3 Darwin/21.6.0",
            "Podkaster/1710.17 CFNetwork/1399 Darwin/22.1.0",
            "Balados/1660.5 CFNetwork/1335.0.3 Darwin/21.6.0",
            "Podcast/1660.5 CFNetwork/1335.0.3 Darwin/21.6.0",
            "Podcast%E2%80%99ler/1710.17 CFNetwork/1399 Darwin/22.1.0",
            "%E0%B8%9E%E0%B9%87%E0%B8%AD%E0%B8%94%E0%B8%84%E0%B8%B2%E0%B8%AA%E0%B8%97%E0%B9%8C/4022.300.6 CFNetwork/1402.0.8 Darwin/22.2.0",
        ],
    },
    {
    ...
    {"name": "Aural", "pattern": re.compile("^Aural/"), "examples": ["Aural/1.3 CFNetwork/609.1.4 Darwin/13.0.0"]},
    {"name": "Aurora", "pattern": re.compile("^Aurora/"), "examples": ["Aurora/175 CFNetwork/758.4.3 Darwin/15.5.0"]},
    {"name": "Autopod", "pattern": re.compile("^Autopod/"), "examples": ["Autopod/0 CFNetwork/609.1.4 Darwin/13.0.0"]},
    {
        "name": "avassetReader",
        "pattern": re.compile("^avassetReader/"),
        "examples": ["avassetReader/1 CFNetwork/887 Darwin/17.0.0"],
    },
    {"name": "avopodo", "pattern": re.compile("^avopodo/"), "examples": ["avopodo/2 CFNetwork/975.0.3 Darwin/18.2.0"]},
    {"name": "AVPlay", "pattern": re.compile("^AVPlay/"), "examples": ["AVPlay/2 CFNetwork/811.5.4 Darwin/16.7.0"]},
    {"name": "Azul", "pattern": re.compile("^Azul/"), "examples": ["Azul/5.8 CFNetwork/711.1.16 Darwin/14.0.0"]},
    {
        "name": "BaladoQuebec",
    ...
    {"name": "BashPodder", "pattern": re.compile("^BashPodder"), "urls": ["http://lincgeek.org/bashpodder/"]},
    {
    ...
    {"name": "Bear", "pattern": re.compile("^Bear/"), "examples": ["Bear/5702 CFNetwork/811.8 Darwin/16.7.0 (x86_64)"]},
    {
    ...
    {"name": "BeyondPod", "pattern": re.compile("; BeyondPod"), "examples": ["Mozilla/5.0 (Linux; U; en-us; BeyondPod 4)"]},
    {"name": "bgwnr", "pattern": re.compile("^bgwnr/"), "examples": ["bgwnr/3300 CFNetwork/975.0.3 Darwin/18.0.0"]},
    {"name": "Bible", "pattern": re.compile("^Bible/"), "examples": ["Bible/11 CFNetwork/978.0.7 Darwin/18.6.0"]},
    {
        "name": "Bitcast",
        ...
        "examples": [
            ...
            "Bitcast.fm/104 CFNetwork/1126 Darwin/19.5.0",
            "bitcast 4 reel/47 CFNetwork/1121.2.1 Darwin/19.3.0",
            "bitcastbitcast/45 CFNetwork/1121.2.2 Darwin/19.3.0",
        ],
    },
    {"name": "Bitly", "pattern": re.compile("^Bitly/"), "examples": ["Bitly/445 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "BizCoachPal",
        "pattern": re.compile("^BizCoachPal/"),
        "examples": ["BizCoachPal/1.5.7.24.4 CFNetwork/711.0.6 Darwin/14.0.0"],
    },
    {"name": "BMR", "pattern": re.compile("^BMR/"), "examples": ["BMR/1 CFNetwork/902.2 Darwin/17.7.0"]},
    {"name": "Bolt", "pattern": re.compile("^Bolt/"), "examples": ["Bolt/10 CFNetwork/1098.7 Darwin/19.0.0"]},
    {"name": "Bookmobile", "pattern": re.compile("^Bookmobile/"), "examples": ["Bookmobile/1 CFNetwork/894 Darwin/17.4.0"]},
    {"name": "Bookself", "pattern": re.compile("^Bookself/"), "examples": ["Bookself/1 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {"name": "Boom", "pattern": re.compile("^Boom/"), "examples": ["Boom/1.3.110001 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "Bose SoundTouch", "pattern": re.compile("^Bose/")},
    {"name": "bPod", "pattern": re.compile("^bPod$"), "examples": ["bPod"]},
    {"name": "Breaker", "pattern": re.compile("^Breaker/")},
    {"name": "Breez", "pattern": re.compile("^breez/"), "examples": ["breez/5585.1 CFNetwork/1402 Darwin/22.2.0"]},
    {"name": "BrewApp", "pattern": re.compile("^BrewApp/"), "examples": ["BrewApp/262 CFNetwork/975.0.3 Darwin/18.2.0"]},
    {"name": "Broadcast", "pattern": re.compile("^Broadcast/"), "examples": ["Broadcast/1.0 CFNetwork/893.14.2 Darwin/17.3.0"]},
    {
    ...
    {"name": "Browser", "pattern": re.compile("^Browser/"), "examples": ["Browser/21060 CFNetwork/887 Darwin/17.0.0"]},
    {
        "name": "Browser iOS",
    ...
    },
    {
        ...
        "examples": [
            ...
            "Bullhorn/1 CFNetwork/1335.0.3 Darwin/21.6.0",
        ],
    },
    {
    ...
    {"name": "Canvas", "pattern": re.compile("^Canvas/"), "examples": ["Canvas/7369 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Capital", "pattern": re.compile("^Capital/"), "examples": ["Capital/1528207522 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "capsule.fm", "pattern": re.compile("^capsule\\.fm/"), "examples": ["capsule.fm/1 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "Cast", "pattern": re.compile("^Cast/"), "examples": ["Cast/1031 CFNetwork/711.4.6 Darwin/14.0.0"]},
    {
        "name": "Castamatic",
        ...
        "examples": [
            "Castamatic/3847 CFNetwork/1240.0.4 Darwin/20.6.0",
            "Castamatic/5.1.4 (com.gunpmedia.Castamatic; build:3136; iOS 13.1.3) Alamofire/4.9.0",
        ],
    },
    {"name": "Castaway", "pattern": re.compile("^Castaway/"), "examples": ["Castaway/8 CFNetwork/1098.7 Darwin/19.0.0"]},
    {
        "name": "CastBox",
        ...
        "examples": [
            ...
            "CastBox/10.1.0-221129106 (Linux;Android 10) ExoPlayerLib/2.10.4, CastBox/10.1.0-221129106 (Linux;Android 10) ExoPlayerLib/2.10.4, CastBox/10.1.0-221129106 (Linux;Android 10) ExoPlayerLib/2.10.4",
        ],
    },
    {"name": "Casterbate", "pattern": re.compile("^Casterbate/"), "examples": ["Casterbate/1 CFNetwork/744.5 Darwin/14.4.0"]},
    {
        "name": "castget",
    ...
    {"name": "Casts", "pattern": re.compile("^Casts/"), "examples": ["Casts/652 CFNetwork/758.2.8 Darwin/15.0.0"]},
    {"name": "CCGF", "pattern": re.compile("^CCGF/"), "examples": ["CCGF/4.4.1 CFNetwork/758.5.3 Darwin/15.6.0"]},
    {"name": "CEBrowser", "pattern": re.compile("^CEBrowser/"), "examples": ["CEBrowser/2.5.2.4 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "CFC", "pattern": re.compile("^CFC/"), "examples": ["CFC/1 CFNetwork/711.3.18 Darwin/14.0.0"]},
    {"name": "CHCLeaders", "pattern": re.compile("^CHCLeaders/"), "examples": ["CHCLeaders/11 CFNetwork/894 Darwin/17.4.0"]},
    {"name": "Childress", "pattern": re.compile("^Childress/"), "examples": ["Childress/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "chorus", "pattern": re.compile("^chorus/"), "examples": ["chorus/698 CFNetwork/811.5.4 Darwin/16.6.0"]},
    {
    ...
    {"name": "ChurchLink", "pattern": re.compile("^ChurchLink/"), "examples": ["ChurchLink/110519 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Clammr", "pattern": re.compile("^Clammr/"), "examples": ["Clammr/5 CFNetwork/758.3.15 Darwin/15.4.0"]},
    {
        "name": "Classic FM",
        "pattern": re.compile("^Classic FM/"),
        "examples": ["Classic FM/1563188702 CFNetwork/978.0.7 Darwin/18.7.0"],
    },
    {"name": "Client", "pattern": re.compile("^Client/"), "examples": ["Client/16042 CFNetwork/1098.7 Darwin/19.0.0"]},
    {"name": "Clementine Music Player", "pattern": re.compile("^Clementine "), "urls": ["https://www.clementine-player.org/"]},
    {"name": "Club", "pattern": re.compile("^Club/"), "examples": ["Club/126 CFNetwork/672.1.15 Darwin/14.0.0"]},
    {"name": "Commotion", "pattern": re.compile("^Commotion/"), "examples": ["Commotion/3.0.79 CFNetwork/609 Darwin/13.0.0"]},
    {"name": "Copied", "pattern": re.compile("^Copied/"), "examples": ["Copied/142 CFNetwork/760.2.6 Darwin/15.2.0 (x86_64)"]},
    {
    ...
    {"name": "Cosmicast", "pattern": re.compile("^Cosmicast/"), "examples": ["Cosmicast/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "CPod",
    ...
    {"name": "Crosspointe", "pattern": re.compile("^Crosspointe/"), "examples": ["Crosspointe/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "CrossPreach",
    ...
    {"name": "DaumWebtoon", "pattern": re.compile("^DaumWebtoon/"), "examples": ["DaumWebtoon/1 CFNetwork/975.0.3 Darwin/18.2.0"]},
    {
        "name": "Deezer",
        ...
        "examples": [
            ...
            "DeezerJukebox/6.2.26.58 (Linux;Android 10) ExoPlayerLib/2.12.1",
    ...
    {"name": "Delve", "pattern": re.compile("^Delve/"), "examples": ["Delve/41 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {
        "name": "DevCasts",
    ...
    {"name": "DManager", "pattern": re.compile("^DManager/"), "examples": ["DManager/27 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Documents", "pattern": re.compile("^Documents/"), "examples": ["Documents/6.9.8.634 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "DoggCatcher",
    ...
    {"name": "Downie", "pattern": re.compile("^Downie/"), "examples": ["Downie/1108 CFNetwork/760.2.6 Darwin/15.2.0 (x86_64)"]},
    {
        "name": "DownloadAll",
    ...
    {"name": "Downloads", "pattern": re.compile("^Downloads/"), "examples": ["Downloads/20375 CFNetwork/1098.7 Darwin/19.0.0"]},
    {"name": "DownMan", "pattern": re.compile("^DownMan/"), "examples": ["DownMan/3.0.1 CFNetwork/609 Darwin/13.0.0"]},
    {
        "name": "DowntonAppy",
        "pattern": re.compile("^DowntonAppy/"),
        "examples": ["DowntonAppy/1382280772 CFNetwork/548.0.4 Darwin/11.0.0"],
    },
    {"name": "DriveCast", "pattern": re.compile("^DriveCast/"), "examples": ["DriveCast/2.9 CFNetwork/609.1.4 Darwin/13.0.0"]},
    {"name": "DroolRadio", "pattern": re.compile("^DroolRadio/"), "examples": ["DroolRadio/38 CFNetwork/609.1.4 Darwin/13.0.0"]},
    {"name": "Dynamo", "pattern": re.compile("^Dynamo/"), "examples": ["Dynamo/1.0"]},
    {
    ...
    {"name": "Earbud", "pattern": re.compile("^Earbud/"), "examples": ["Earbud/0 CFNetwork/758.4.3 Darwin/15.5.0"]},
    {"name": "EasyGet", "pattern": re.compile("^EasyGet/"), "examples": ["EasyGet/1.0.70 CFNetwork/672.1.13 Darwin/14.0.0"]},
    {
    ...
    {"name": "Encounter", "pattern": re.compile("^Encounter/"), "examples": ["Encounter/1 CFNetwork/711.3.18 Darwin/14.0.0"]},
    {"name": "EpisodeFever", "pattern": re.compile("^EpisodeFever/"), "examples": ["EpisodeFever/21 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "EQu", "pattern": re.compile("^EQu/"), "examples": ["EQu/14101 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "EvanApp", "pattern": re.compile("^EvanApp/"), "examples": ["EvanApp/1 CFNetwork/897.15 Darwin/17.5.0"]},
    {"name": "Expo", "pattern": re.compile("^Expo/"), "examples": ["Expo/2.11.1.106175 CFNetwork/976 Darwin/18.2.0"]},
    {
        "name": "ExtDownloader",
        "pattern": re.compile("^ExtDownloader/"),
        "examples": ["ExtDownloader/5.0.2 CFNetwork/758.2.8 Darwin/15.0.0"],
    },
    {"name": "ExtraCloud", "pattern": re.compile("^ExtraCloud/"), "examples": ["ExtraCloud/1.3 CFNetwork/758.2.8 Darwin/15.0.0"]},
    {
        "name": "Facebook",
        ...
        "examples": [
            ...
            "facebook-mobile/1.0",
            "Facebook/180461199 CFNetwork/1107.1 Darwin/19.0.0",
            "[FBAN/FB4A;FBAV/180.0.0.35.82;FBBV/116984898;FBDM/{density=1.5,width=480,height=854};FBLC/en_US;FBRV/0;FBCR/Verizon Wireless;FBMF/ZTE;FBBD/ZTE;FBPN/com.facebook.katana;FBDV/Z899VL;FBSV/7.1.1;FBOP/19;FBCA/armeabi-v7a:armeabi;]",
        ],
    },
    {
        "name": "FaithPlay",
    ...
    {"name": "Fallound", "pattern": re.compile("^Fallound/"), "examples": ["Fallound/16 CFNetwork/975.0.3 Darwin/18.2.0"]},
    {"name": "FancyMusic", "pattern": re.compile("^FancyMusic/"), "examples": ["FancyMusic/2 CFNetwork/758.1.6 Darwin/15.0.0"]},
    {
        "name": "Fathom",
    ...
    {"name": "Feeder", "pattern": re.compile("^Feeder/"), "examples": ["Feeder/2785 CFNetwork/720.5.7 Darwin/14.5.0 (x86_64)"]},
    {
        "name": "Feedly",
    ...
    {"name": "Filebox", "pattern": re.compile("^Filebox/"), "examples": ["Filebox/2.7.3 CFNetwork/811.4.18 Darwin/16.5.0"]},
    {"name": "FileBrowser", "pattern": re.compile("^FileBrowser/"), "examples": ["FileBrowser/3 CFNetwork/758.4.3 Darwin/15.5.0"]},
    {"name": "Filer", "pattern": re.compile("^Filer/"), "examples": ["Filer/351 CFNetwork/976 Darwin/18.2.0"]},
    ...
    },
    {
        ...
        "examples": [
            ...
            "Fountain/0.3.8 ios https://www.fountain.fm",
            "Fountain/0.2.6 Android https://www.fountain.fm'",
            "Fountain/0.3.13 android https://www.fountain.fm",
            "fountainapp/565 CFNetwork/1399 Darwin/22.1.0",
        ],
    },
    {
    ...
    {"name": "freemusic", "pattern": re.compile("^freemusic/"), "examples": ["freemusic/2.3 CFNetwork/609 Darwin/13.0.0"]},
    {
    ...
    },
    {
        ...
        "examples": [
            ...
            "Gaana-iOS",
            "Gaana/1768 CFNetwork/978.0.7 Darwin/18.7.0",
        ],
    },
    {
    ...
    {"name": "GBEngine", "pattern": re.compile("^GBEngine/"), "examples": ["GBEngine/1.2 CFNetwork/672.1.14 Darwin/14.0.0"]},
    {"name": "GMB Show", "pattern": re.compile("^GMB Show/"), "examples": ["GMB Show/1.2.0 (iPad; iOS 9.3.2; Scale/2.00)"]},
    {"name": "Godster", "pattern": re.compile("^Godster/"), "examples": ["Godster/2.0.6 (Linux;Android 9) ExoPlayerLib/2.8.3"]},
    {"name": "Gold", "pattern": re.compile("^Gold/"), "examples": ["Gold/1528207522 CFNetwork/902.2 Darwin/17.7.0"]},
    {
        "name": "GoldenPod",
        "pattern": re.compile("^GoldenPod/"),
        "examples": ["GoldenPod/0.8.4 (GNU/Linux; podcatcher; Using LWP) libwwwperl"],
    },
    {"name": "GoLoud", "pattern": re.compile("^GoLoud/"), "examples": ["GoLoud/1092 CFNetwork/978.0.7 Darwin/18.6.0"]},
    {
        "name": "Goodpods",
        ...
        "examples": [
            "Goodpods.Android / 2.2.2",
            "Goodpods.Android / 3.2.9",
            "Goodpods.iOS / 2.2.2",
            "Goodpods/1 CFNetwork/1329 Darwin/21.3.0",
            "goodpods/1 CFNetwork/1107.1 Darwin/18.7.0",
            "Goodpods/3 CFNetwork/1128.0.1 Darwin/19.6.0",
        ],
    },
    {
        "name": "GoodReader",
        ...
        "examples": [
            ...
            "GoodReaderIPad/3.20.0 CFNetwork/711.3.18 Darwin/14.0.0",
        ],
    },
    {
    ...
    {"name": "Google Nest Hub", "pattern": "(Fuchsia).* CrKey/"},
    {
        ...
        "examples": [
            ...
            "GooglePodcasts/2.0.10 iPhone/14.6 hw/iPhone13_3",
    ...
    },
    {
        ...
        "examples": [
            ...
            "gPodder/3.10.21 (+http://gpodder.org/) Linux",
            "gPodder/3.10.15 (+http://gpodder.org/) Linux/5.4.0-74-generic",
            "gPodder/3.10.15 (+http://gpodder.org/) Linux/5.4.0-90-generic",
            "gPodder/3.10.17 (+http://gpodder.org/) Linux/5.11.0-49-generic",
    ...
    {"name": "Gretale", "pattern": re.compile("^Gretale/"), "examples": ["Gretale/207 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {"name": "GroupMe", "pattern": re.compile("^GroupMe/"), "examples": ["GroupMe/5.33.1.1 CFNetwork/1098.7 Darwin/19.0.0"]},
    {
        "name": "Guardian",
    ...
    {"name": "HalfTunes", "pattern": re.compile("^HalfTunes/"), "examples": ["HalfTunes/7 CFNetwork/893.14 Darwin/16.7.0"]},
    {"name": "Hammel", "pattern": re.compile("^Hammel/"), "examples": ["Hammel/1.5 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "HardCast", "pattern": re.compile("^HardCast/"), "examples": ["HardCast/11 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {
        "name": "Hark Audio",
    ...
    {"name": "Heart", "pattern": re.compile("^Heart/"), "examples": ["Heart/1528207522 CFNetwork/897.15 Darwin/17.5.0"]},
    {
        "name": "HermesPod",
    ...
    {"name": "HiCast", "pattern": re.compile("^HiCast/"), "examples": ["HiCast/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Highly", "pattern": re.compile("^Highly/"), "examples": ["Highly/914 CFNetwork/758.5.3 Darwin/15.6.0"]},
    {
        "name": "Himalaya",
    ...
    {"name": "Horse Radio Network", "pattern": re.compile("^HRN/"), "examples": ["HRN/1900 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Hubhopper", "pattern": re.compile("^Hubhopper$"), "examples": ["Hubhopper"]},
    {"name": "Hyper", "pattern": re.compile("^Hyper/"), "examples": ["Hyper/3 CFNetwork/893.14.2 Darwin/17.3.0"]},
    {
        "name": "HyperCatcher",
    ...
    {"name": "iBuilder", "pattern": re.compile("^iBuilder/"), "examples": ["iBuilder/1 CFNetwork/548.1.4 Darwin/11.0.0"]},
    {
        "name": "iCatcher",
        "pattern": re.compile("^i[Cc]atcher|\\(iCatcher"),
        "examples": ["icatcher/4506 CFNetwork/609.1.4 Darwin/13.0.0", "iTunes (iCatcher!/2.6.3)"],
    },
    {"name": "iDL", "pattern": re.compile("^iDL/"), "examples": ["iDL/122 CFNetwork/811.5.4 Darwin/16.7.0"]},
    {
        "name": "iDownloader",
        ...
        "examples": [
            ...
            "iDownloaderLite/1.3 CFNetwork/609.1.4 Darwin/13.0.0",
            "iDownloaderPro/1.0.1 CFNetwork/672.0.2 Darwin/14.0.0",
        ],
    },
    {
    ...
    {"name": "iFeedTouch", "pattern": re.compile("^iFeedTouch/"), "examples": ["iFeedTouch/1.02 CFNetwork/811.5.4 Darwin/16.7.0"]},
    {
        "name": "Iframely",
    ...
    {"name": "IFTTT", "pattern": re.compile("^IFTTT/"), "examples": ["IFTTT/550 CFNetwork/758.5.3 Darwin/15.6.0"]},
    {
        "name": "iHeartRadio",
        ...
        "examples": [
            ...
            "iHeartPodcasts/1.1.0 (Android 10; SM-A505FN Build/QP1A.190711.020)",
        ],
    },
    {"name": "iHorror", "pattern": re.compile("^iHorror/"), "examples": ["iHorror/1.2.6 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "InCast", "pattern": re.compile("^InCast/"), "examples": ["InCast/3443 CFNetwork/711.0.6 Darwin/14.0.0"]},
    {
        "name": "Instacast",
    ...
    {"name": "IPF", "pattern": re.compile("^IPF/"), "examples": ["IPF/1 CFNetwork/901.1 Darwin/17.6.0"]},
    {"name": "iPlay", "pattern": re.compile("^iPlay/"), "examples": ["iPlay/1 CFNetwork/889.9 Darwin/17.2.0"]},
    {"name": "isitgood", "pattern": re.compile("^isitgood/"), "examples": ["isitgood/246 CFNetwork/978.0.7 Darwin/18.6.0"]},
    {
        "name": "iTunes",
        ...
        "examples": [
            ...
            "iTunes-iPhone",
            "iTunesU/3.4 iOS/9.3.2 model/iPod7,1 hwp/t7000 build/13F69 (4; dt:123)",
        ],
    },
    {
        "name": "iVoox",
        ...
        "examples": [
            ...
            "ivooxApp/2.281.428_428 (G8341; Android 9; d:420031; E5A4)",
            "Ivoox 2.3 (iPod touch; iPhone OS 6.1.5; es_MX)",
        ],
    },
    {"name": "iWeb", "pattern": re.compile("^iWeb/"), "examples": ["iWeb/1.3.0 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "Jabbercast", "pattern": re.compile("^Jabbercast/"), "examples": ["Jabbercast/16 CFNetwork/711.1.16 Darwin/14.0.0"]},
    {"name": "Jimcast", "pattern": re.compile("^Jimcast/"), "examples": ["Jimcast/1.0 CFNetwork/672.1.15 Darwin/14.0.0"]},
    {
        "name": "JioSaavn",
        ...
        "examples": ["com.jio.media.jiobeats/7.3.1 (Linux;Android 8.1.0) ExoPlayerLib/2.11.4", "Saavn Player"],
    },
    {
    ...
    {"name": "Juice", "pattern": re.compile("^Juice/"), "examples": ["Juice/2.2 (Darwin) +http://juicereceiver.sf.net/"]},
    {
        "name": "Just Audio",
    ...
    {"name": "KKBOX", "pattern": re.compile("^KKBOX/"), "examples": ["KKBOX/7.10.70/iOS/14.2"]},
    {"name": "Kloudie", "pattern": re.compile("^Kloudie/"), "examples": ["Kloudie/1.0 CFNetwork/758.1.6 Darwin/15.0.0"]},
    {"name": "Knomad", "pattern": re.compile("^Knomad/"), "examples": ["Knomad/1.1.9 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {
        "name": "Kodi",
    ...
    {"name": "KREAFUNK", "pattern": re.compile("^KREAFUNK/"), "examples": ["KREAFUNK/1.7 CFNetwork/711.3.18 Darwin/14.0.0"]},
    {"name": "labs", "pattern": re.compile("^labs/"), "examples": ["labs/0.1.1.5 CFNetwork/711.2.23 Darwin/14.0.0"]},
    {
        "name": "Laughable",
        "pattern": re.compile("^Laughable.+iOS|^Laughable/"),
        "examples": ["Laughable/2.1.6.1 CFNetwork/808.1.4 Darwin/16.1.0"],
    },
    {"name": "LBC", "pattern": re.compile("^LBC/"), "examples": ["LBC/1544724632 CFNetwork/811.5.4 Darwin/16.7.0"]},
    {"name": "Leaf", "pattern": re.compile("^Leaf/"), "examples": ["Leaf/12 CFNetwork/720.0.9 Darwin/14.0.0 (x86_64)"]},
    {
    ...
    {"name": "LG Player", "pattern": re.compile("LG Player")},
    {
        "name": "LifeEssentials",
        ...
        "examples": [
            ...
            "Life%20Essentials/1.0 CFNetwork/672.1.15 Darwin/14.0.0",
        ],
    },
    {
    ...
    },
    {
        ...
        "examples": [
            ...
            "Listen%20App/121 CFNetwork/1399 Darwin/22.1.0",
        ],
    },
    {"name": "Listen5", "pattern": re.compile("Listen5")},
    {
        "name": "Livio Radio",
    ...
    {"name": "Majelan", "pattern": re.compile("^MajelanApp")},
    {"name": "MaxTubePro", "pattern": re.compile("^MaxTubePro/"), "examples": ["MaxTubePro/1.5 CFNetwork/711.1.16 Darwin/14.0.0"]},
    {
    ...
    {"name": "MediaMonkey", "pattern": re.compile("^MediaMonkey")},
    {"name": "Mediatap", "pattern": re.compile("^Mediatap/"), "examples": ["Mediatap/342 CFNetwork/672.1.13 Darwin/14.0.0"]},
    {"name": "Megaphone", "pattern": re.compile("^Megaphone\\.fm"), "examples": ["Megaphone.fm"]},
    {
        "name": "Menucast",
    ...
    {"name": "Messenger", "pattern": re.compile("^Messenger/"), "examples": ["Messenger/168725151 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "Microsoft Xbox",
    ...
    {"name": "Mimir", "pattern": re.compile("^Mimir/"), "examples": ["Mimir/1 CFNetwork/1098 Darwin/19.0.0 (x86_64)"]},
    {
        "name": "Miro",
    ...
    },
    {
        ...
        "examples": [
            ...
            "MixerBox/869 CFNetwork/1300.1 Darwin/21.0.0",
        ],
    },
    {"name": "MobileApp", "pattern": re.compile("^MobileApp/"), "examples": ["MobileApp/0 CFNetwork/758.3.15 Darwin/17.4.0"]},
    {"name": "MobileSMS", "pattern": re.compile("^MobileSMS/"), "examples": ["MobileSMS/1.0 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "MoonFM",
        "pattern": re.compile("^Moon ?FM/"),
        "examples": ["MoonFM/128 CFNetwork/978.0.7 Darwin/18.7.0", "Moon FM/4.0.33"],
    },
    {"name": "mpv", "pattern": re.compile("^mpv 0\\.|^libmpv$"), "urls": ["https://mpv.io/"], "examples": ["libmpv"]},
    {"name": "MusicBee", "pattern": re.compile("^MusicBee"), "urls": ["https://getmusicbee.com/"], "examples": ["MusicBee"]},
    {
    ...
    },
    {
        ...
        "examples": [
            ...
            "MyTuner-ExoPlayerAdapter",
            "myTuner",
            "myTuneriOS%20Free/120 CFNetwork/1402.0.8 Darwin/22.2.0",
        ],
    },
    {"name": "Newsboat", "pattern": re.compile("^Newsboat/"), "examples": ["Newsboat/2.29.0 (Linux x86_64)"]},
    {
        "name": "Newsly",
    ...
    {"name": "PeaCast", "pattern": re.compile("^PeaCast/"), "examples": ["PeaCast/0.7"]},
    {
        "name": "Playapod",
    ...
    },
    {
        ...
        "examples": ["Pocket Casts", "Shifty Jelly Pocket Casts, iOS v4.2"],
    },
    {"name": "Podbay", "pattern": re.compile("^Podbay/"), "examples": ["Podbay/21 CFNetwork/1335.0.3 Darwin/21.6.0"]},
    {
        "name": "Podbean",
    ...
    {"name": "Podcoin", "pattern": re.compile("^Podcoin")},
    {
        "name": "PodCruncher",
    ...
    {"name": "Podeo", "pattern": re.compile("^Podeo/"), "examples": ["Podeo/4.2.3 (Linux;Android 12) ExoPlayerLib/2.11.7"]},
    {
        "name": "Podfriend",
        ...
        "examples": [
            "Podfriend/1.0 Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) PodFriend/0.7.11 Chrome/83.0.4103.122 Electron/9.2.0 Safari/537.36"
        ],
    },
    {
        "name": "Podhero",
    ...
    },
    {
        ...
        "examples": ["Podimo/1.11.3 build 121/iOS 13.3", "Podimo/1.11.3 build 91/Android 28"],
    },
    {
        "name": "PodKast app",
    ...
    {"name": "Podkicker Pro", "pattern": re.compile("^Podkicker")},
    {"name": "PodLink", "pattern": re.compile("PodLink"), "svg": "podlink.svg", "urls": ["https://pod.link/faq/crawler"]},
    {
    ...
    },
    {
        ...
        "svg": "podmn.svg",
        "urls": [
            "https://play.google.com/store/apps/details?id=com.podmn.app",
            "https://apps.apple.com/us/app/podmn/id1464935818",
        ],
        "examples": [
    ...
    {"name": "PodNL", "pattern": re.compile("^PodNL/"), "examples": ["PodNL/47 CFNetwork/1107.1 Darwin/19.0.0"]},
    {
        "name": "Podnods",
    ...
    {"name": "PodQast", "pattern": re.compile("^PodQast/"), "examples": ["PodQast/2.23 +https://gitlab.com/cy8aer/podqast"]},
    {"name": "Pods", "pattern": re.compile("^Pods/"), "examples": ["Pods/1 CFNetwork/1312 Darwin/21.0.0"]},
    {
        "name": "Podurama",
    ...
    {"name": "PodTrapper", "pattern": re.compile("^PodTrapper"), "examples": ["PodTrapper"]},
    {
        "name": "Podvine",
    ...
    },
    {
        ...
        "examples": [
            ...
            "Podverse/Android Mobile App/Mozilla/5.0 (Linux; Android 12; SM-S134DL Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/105.0.5195.136 Mobile Safari/537.36",
            ...
            "podverse/393 CFNetwork/1128.0.1 Darwin/19.6.0",
        ],
    },
    {
        "name": "Podyssey",
    ...
    },
    {
        ...
        "urls": ["https://www.pugpig.com/products-and-services"],
    },
    {
        "name": "radio.de",
    ...
    },
    {
        ...
        "urls": ["https://repod.io/"],
        "examples": [
            "Repod/2.9.0.363 CFNetwork/1240.0.4 Darwin/20.6.0 (iPhone/X iOS/14.7.1)",
            "Repod/2.9.0.221 Mozilla/5.0 (Linux; Android 11; Pixel 3 Build/RQ3A.210905.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/94.0.4606.85 Mobile Safari/537.36",
        ],
    },
    {
        "name": "Roka Stereo",
    ...
    {"name": "Roku", "pattern": re.compile("^Roku/"), "examples": ["Roku/DVP-9.10 (499.10E04121A)"]},
    {
        "name": "Rhythmbox",
    ...
    {"name": "Shadow", "pattern": re.compile("^Shadow"), "urls": ["https://apps.apple.com/us/app/shadow/id940127690"]},
    {"name": "SiriusXM", "pattern": re.compile("^SiriusXM/"), "examples": ["SiriusXM/1608138304 CFNetwork/1206 Darwin/20.1.0"]},
    {"name": "Slack", "pattern": re.compile("^Slack/")},
    {
        "name": "Snipd",
    ...
    {"name": "Sodes", "pattern": re.compile("^Sodes/"), "examples": ["Sodes/1657 CFNetwork/1098.6 Darwin/19.0.0"]},
    {
        "name": "Sonnet",
    ...
    {"name": "Sonos", "pattern": re.compile("Sonos")},
    {
        "name": "SoundOn",
    ...
    },
    {
        ...
        "examples": [
            ...
            "spotify_android-tablet",
            "Spotify-Lite: Spotify-Lite/0.13.48.96 Android/22 (SM-G531H)",
            "Spotify/4.3.2.0 Polestar/30 (Polestar)",
            "Spotify/4.3.2.0 Volvo/30 (Volvo)",
    ...
    {"name": "Storiyoh", "pattern": re.compile("^Storiyoh/")},
    {
        "name": "StoryShots",
    ...
    {"name": "Subcast", "pattern": re.compile("^Subcast")},
    {
    ...
    },
    {
        ...
        "examples": [
            ...
            "podcast/ CFNetwork/1107 Darwin/19.0.0",
            "podcast/878 CFNetwork/1335.0.3 Darwin/21.6.0",
            "PodcastApp/22.10.30 CFNetwork/1333.0.4 Darwin/21.5.0",
        ],
    },
    {
    ...
    {"name": "Treble", "pattern": re.compile("^TREBLE/"), "examples": ["TREBLE/1.0"]},
    {
        "name": "Tumult",
    ...
    },
    {
        ...
        "examples": [
            ...
            "TuneIn Radio Pro/24.2.1; iPhone13,4; iOS/16.1",
            "TuneIn Radio",
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) TuneIn/1.25.0 Chrome/69.0.3497.128 Electron/4.2.8 Safari/537.36",
        ],
    },
    {
        "name": "Twitter",
    ...
    {"name": "Ubook Player", "pattern": re.compile("^Ubook Player"), "examples": ["Ubook Player"]},
    {"name": "uTorrent", "pattern": re.compile("^uTorrent|BTWebClient"), "examples": ["BTWebClient/1870(43938)"]},
    {
    ...
    {"name": "VictorReader", "pattern": re.compile("^VictorReader Stream|^VictorReader_"), "examples": ["VictorReader_4-4-2"]},
    {
    ...
    {"name": "Winamp", "pattern": re.compile("^Winamp"), "examples": ["WinampMPEG/2.7"]},
    {"name": "WeCast", "pattern": re.compile("^WeCast/"), "examples": ["WeCast/3.050 CFNetwork/672.1.14 Darwin/14.0.0"]},
    {"name": "WhatsApp", "pattern": re.compile("^WhatsApp/"), "examples": ["WhatsApp/0.3.5374 N"]},
    {
        ...
        "examples": [
            ...
            "Lavf52.104.0 WMPlayer/10.0.0.364 guid/3300AD50-2C39-46C0-AE0A-AC7B8159E203",
        ],
    },
    {
        "name": "Xiao Yu Zhou",
        ...
        "examples": ["Xiaoyuzhou/1.9.6 Android/10", "Xiaoyuzhou/1.9.0", "Xiaoyuzhou/1.5.1"],
    },
    {
        "name": "XING",
        ...
        "examples": [
            "Mozilla/5.0 (iPhone; CPU iPhone OS 13_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) ; iPhone/13.6 XING/8.15.2 ttt_webview_iosm"
        ],
    },
    {"name": "Yandex Music", "pattern": re.compile("^Yandex\\.Music/"), "examples": ["Yandex.Music/2019-11-01.trunk.5885661"]},
    {"name": "Yapa", "pattern": re.compile("^yapa/")},
    {"name": "Zeno", "pattern": re.compile("^Zeno$"), "urls": ["https://zeno.fm/"], "examples": ["Zeno"]},
    {"name": "Zune", "pattern": re.compile("Zune/"), "examples": ["Zune/4.8"]},
    {
        "name": "小宇宙",
