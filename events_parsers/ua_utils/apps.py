apps = [
    ...
    {"name": "Agora", "pattern": "^Agora/", "examples": ["Agora/37 CFNetwork/974.2.1 Darwin/18.0.0"]},
    ...
    {"name": "AMPApp", "pattern": "^AMPApp/", "examples": ["AMPApp/32.6.1 CFNetwork/978.0.7 Darwin/18.6.0"]},
    {"name": "Anchor", "pattern": "^Anchor/", "examples": ["Anchor/9 CFNetwork/901.1 Darwin/17.5.0"]},
    ...
    {"name": "Aural", "pattern": "^Aural/", "examples": ["Aural/1.3 CFNetwork/609.1.4 Darwin/13.0.0"]},
    {"name": "Aurora", "pattern": "^Aurora/", "examples": ["Aurora/175 CFNetwork/758.4.3 Darwin/15.5.0"]},
    ...
    {"name": "AVPlay", "pattern": "^AVPlay/", "examples": ["AVPlay/2 CFNetwork/811.5.4 Darwin/16.7.0"]},
    ...
    {"name": "BeyondPod", "pattern": "; BeyondPod", "examples": ["Mozilla/5.0 (Linux; U; en-us; BeyondPod 4)"]},
    {"name": "bgwnr", "pattern": "^bgwnr/", "examples": ["bgwnr/3300 CFNetwork/975.0.3 Darwin/18.0.0"]},
    ...
    {"name": "Bolt", "pattern": "^Bolt/", "examples": ["Bolt/10 CFNetwork/1098.7 Darwin/19.0.0"]},
    {"name": "Bookmobile", "pattern": "^Bookmobile/", "examples": ["Bookmobile/1 CFNetwork/894 Darwin/17.4.0"]},
    {"name": "Bookself", "pattern": "^Bookself/", "examples": ["Bookself/1 CFNetwork/978.0.7 Darwin/18.7.0"]},
    {"name": "Boom", "pattern": "^Boom/", "examples": ["Boom/1.3.110001 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "Bose SoundTouch", "pattern": "^Bose/"},
    {"name": "bPod", "pattern": "^bPod$", "examples": ["bPod"]},
    {"name": "Breaker", "pattern": "^Breaker/"},
    {"name": "Breez", "pattern": "^breez/", "examples": ["breez/5585.1 CFNetwork/1402 Darwin/22.2.0"]},
    {"name": "BrewApp", "pattern": "^BrewApp/", "examples": ["BrewApp/262 CFNetwork/975.0.3 Darwin/18.2.0"]},
    ...
    {"name": "Canvas", "pattern": "^Canvas/", "examples": ["Canvas/7369 CFNetwork/1107.1 Darwin/19.0.0"]},
    {"name": "Capital", "pattern": "^Capital/", "examples": ["Capital/1528207522 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "capsule.fm", "pattern": "^capsule\\.fm/", "examples": ["capsule.fm/1 CFNetwork/976 Darwin/18.2.0"]},
    ...
    {"name": "CCGF", "pattern": "^CCGF/", "examples": ["CCGF/4.4.1 CFNetwork/758.5.3 Darwin/15.6.0"]},
    {"name": "CEBrowser", "pattern": "^CEBrowser/", "examples": ["CEBrowser/2.5.2.4 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "CFC", "pattern": "^CFC/", "examples": ["CFC/1 CFNetwork/711.3.18 Darwin/14.0.0"]},
    {"name": "CHCLeaders", "pattern": "^CHCLeaders/", "examples": ["CHCLeaders/11 CFNetwork/894 Darwin/17.4.0"]},
    {"name": "Childress", "pattern": "^Childress/", "examples": ["Childress/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    ...
    {"name": "ChurchLink", "pattern": "^ChurchLink/", "examples": ["ChurchLink/110519 CFNetwork/1107.1 Darwin/19.0.0"]},
    ...
    {"name": "Clementine Music Player", "pattern": "^Clementine ", "urls": ["https://www.clementine-player.org/"]},
    {"name": "Club", "pattern": "^Club/", "examples": ["Club/126 CFNetwork/672.1.15 Darwin/14.0.0"]},
    {"name": "Commotion", "pattern": "^Commotion/", "examples": ["Commotion/3.0.79 CFNetwork/609 Darwin/13.0.0"]},
    ...
    {"name": "DManager", "pattern": "^DManager/", "examples": ["DManager/27 CFNetwork/1107.1 Darwin/19.0.0"]},
    ...
    {"name": "DroolRadio", "pattern": "^DroolRadio/", "examples": ["DroolRadio/38 CFNetwork/609.1.4 Darwin/13.0.0"]},
    ...
    {"name": "Earbud", "pattern": "^Earbud/", "examples": ["Earbud/0 CFNetwork/758.4.3 Darwin/15.5.0"]},
    ...
    {"name": "EpisodeFever", "pattern": "^EpisodeFever/", "examples": ["EpisodeFever/21 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "EQu", "pattern": "^EQu/", "examples": ["EQu/14101 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "EvanApp", "pattern": "^EvanApp/", "examples": ["EvanApp/1 CFNetwork/897.15 Darwin/17.5.0"]},
    ...
    {"name": "FileBrowser", "pattern": "^FileBrowser/", "examples": ["FileBrowser/3 CFNetwork/758.4.3 Darwin/15.5.0"]},
    {"name": "Filer", "pattern": "^Filer/", "examples": ["Filer/351 CFNetwork/976 Darwin/18.2.0"]},
    {"name": "Files", "pattern": "^Files/", "examples": ["Files/1.0 CFNetwork/758.3.15 Darwin/15.4.0"]},
    {"name": "FilesPro", "pattern": "^FilesPro/", "examples": ["FilesPro/646 CFNetwork/711.1.16 Darwin/14.0.0"]},
    {"name": "Fili", "pattern": "^Fili/", "examples": ["Fili/3617 CFNetwork/609.1.4 Darwin/13.0.0"]},
    ...
    {"name": "GBEngine", "pattern": "^GBEngine/", "examples": ["GBEngine/1.2 CFNetwork/672.1.14 Darwin/14.0.0"]},
    {"name": "GMB Show", "pattern": "^GMB Show/", "examples": ["GMB Show/1.2.0 (iPad; iOS 9.3.2; Scale/2.00)"]},
    {"name": "Godster", "pattern": "^Godster/", "examples": ["Godster/2.0.6 (Linux;Android 9) ExoPlayerLib/2.8.3"]},
    ...
    {"name": "Hammel", "pattern": "^Hammel/", "examples": ["Hammel/1.5 CFNetwork/976 Darwin/18.2.0"]},
    ...
    {"name": "HiCast", "pattern": "^HiCast/", "examples": ["HiCast/1 CFNetwork/1107.1 Darwin/19.0.0"]},
    ...
    {"name": "Hubhopper", "pattern": "^Hubhopper$", "examples": ["Hubhopper"]},
    ...
    {"name": "iHorror", "pattern": "^iHorror/", "examples": ["iHorror/1.2.6 CFNetwork/1107.1 Darwin/19.0.0"]},
    ...
    {"name": "iPlay", "pattern": "^iPlay/", "examples": ["iPlay/1 CFNetwork/889.9 Darwin/17.2.0"]},
    ...
    {"name": "iWeb", "pattern": "^iWeb/", "examples": ["iWeb/1.3.0 CFNetwork/711.1.12 Darwin/14.0.0"]},
    {"name": "Jabbercast", "pattern": "^Jabbercast/", "examples": ["Jabbercast/16 CFNetwork/711.1.16 Darwin/14.0.0"]},
    ...
    {"name": "KKBOX", "pattern": "^KKBOX/", "examples": ["KKBOX/7.10.70/iOS/14.2"]},
    {"name": "Kloudie", "pattern": "^Kloudie/", "examples": ["Kloudie/1.0 CFNetwork/758.1.6 Darwin/15.0.0"]},
    ...
    {"name": "KREAFUNK", "pattern": "^KREAFUNK/", "examples": ["KREAFUNK/1.7 CFNetwork/711.3.18 Darwin/14.0.0"]},
    ...
    {"name": "Mediatap", "pattern": "^Mediatap/", "examples": ["Mediatap/342 CFNetwork/672.1.13 Darwin/14.0.0"]},
    ...
    {"name": "MobileApp", "pattern": "^MobileApp/", "examples": ["MobileApp/0 CFNetwork/758.3.15 Darwin/17.4.0"]},
    ...
    {"name": "Podkicker Pro", "pattern": "^Podkicker"},
    ...
    {"name": "SiriusXM", "pattern": "^SiriusXM/", "examples": ["SiriusXM/1608138304 CFNetwork/1206 Darwin/20.1.0"]},
    ...
    {"name": "Ubook Player", "pattern": "^Ubook Player", "examples": ["Ubook Player"]},
    ...
    {"name": "WeCast", "pattern": "^WeCast/", "examples": ["WeCast/3.050 CFNetwork/672.1.14 Darwin/14.0.0"]},
    ...
    {"name": "Yandex Music", "pattern": "^Yandex\\.Music/", "examples": ["Yandex.Music/2019-11-01.trunk.5885661"]},
    {"name": "Yapa", "pattern": "^yapa/"},
    {"name": "Zeno", "pattern": "^Zeno$", "urls": ["https://zeno.fm/"], "examples": ["Zeno"]},
